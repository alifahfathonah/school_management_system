...
<div class="row">
    <div class="col-12">
      <div class="box">
          ...
          <br>
          <div class="">
              <a href="{{ url('admin/jenis/') }}" class="btn btn-default">Kembali</a>
          </div>
          </div>
              <!-- /.box-body -->
        </div>
      ...
      $.ajax({
        ...
        success:function(data)
        {
          ...
          window.setInterval(function () {
            window.location.href='/admin/jenis/part/'+$('#id_jenis').val();
          }, 3500);
        },
        processData: false,
        contentType: false
...
$(".modal_hapus").click(function (e){
  ...
  $(".modal_soal").click(function (e){
  		var m = $(this).attr("id");
      console.log(m);
      window.location.href='/admin/part/soal/'+m;
  });
